...
const Body = () => {
  ...
  //   );
  //   console.log(`${url}lat=${latitude}&lng=${longitude}`);
        ...
        <div className="bg-slate-50 flex  flex-col items-center justify-center ">
          <div className="hero-section  relative h-[30rem] flex  items-center w-full">
            <img
              ...
              src="https://sevilla.abc.es/contenidopromocionado/wp-content/uploads/sites/2/2020/09/hamburguesas-sevilla-gourmet.jpeg"
                ...
                : filteredRestaurants.map((restaurant) => {
                    return (
                      <Link
                        ...
                        // to={`https://corsproxy.io/?https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=22.8235&lng=86.2304589&submitAction=ENTER&restaurantId=${restaurant.info.id}`}
